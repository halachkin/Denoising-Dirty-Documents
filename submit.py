# https://www.kaggle.com/benhamner/denoising-dirty-documents/no-cleaning-benchmark-streaming
...
def image_df_from_array(image_array, image_number):
    ...
    image_df['pixel_value'] = image_array[image_df.row-1, image_df.col-1]
...
with gzip.open("submission.csv.gz", 'w') as submission_file:
    process_images("test_cleaned", submission_file)